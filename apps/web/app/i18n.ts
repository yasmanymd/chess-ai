...
const resources = {
  en: {
    translation: {
      ...
      studyNav: 'Study',
      moreNavigation: 'More',
      studyEyebrow: 'Chess study',
      studyTitle: 'Find the move that matters.',
      studyDescription: 'Solve a focused position, receive a hint, and learn from the explanation.',
      studyCatalog: 'Study exercises',
      'studyCategory.mate-in-one': 'Mate in one',
      'studyCategory.win-material': 'Win material',
      'studyCategory.find-the-best-move': 'Find the best move',
      'studySide.white': 'White to move',
      'studySide.black': 'Black to move',
      studyOpenExercise: 'Open exercise',
      studyBack: 'Back to study',
      studyBoardLabel: 'Study chessboard',
      studyChoosePiece: 'Select one of your pieces to begin.',
      studyChooseDestination: 'Now choose its destination.',
      studyChecking: 'Checking your move…',
      studyCorrect: 'Correct.',
      studyTryAgain: 'Try again.',
      studyInvalidMove: 'That move is not legal in this position. Try again.',
      studyNextExercise: 'Choose another exercise',
      studyProgress: '{{completed}} of {{total}} completed',
      studyCompleted: 'Completed',
      studyResetProgress: 'Reset progress',
      studyResetConfirmation: 'Reset all study progress in this browser?',
  ...
  es: {
    translation: {
      ...
      studyNav: 'Estudiar',
      moreNavigation: 'Más',
      studyEyebrow: 'Estudio de ajedrez',
      studyTitle: 'Encuentra la jugada que importa.',
      studyDescription:
        'Resuelve una posición concreta, recibe una pista y aprende con la explicación.',
      studyCatalog: 'Ejercicios de estudio',
      'studyCategory.mate-in-one': 'Mate en una',
      'studyCategory.win-material': 'Gana material',
      'studyCategory.find-the-best-move': 'Encuentra la mejor jugada',
      'studySide.white': 'Juegan blancas',
      'studySide.black': 'Juegan negras',
      studyOpenExercise: 'Abrir ejercicio',
      studyBack: 'Volver al estudio',
      studyBoardLabel: 'Tablero de estudio',
      studyChoosePiece: 'Selecciona una de tus piezas para comenzar.',
      studyChooseDestination: 'Ahora elige su destino.',
      studyChecking: 'Comprobando tu jugada…',
      studyCorrect: 'Correcto.',
      studyTryAgain: 'Inténtalo de nuevo.',
      studyInvalidMove: 'Esa jugada no es legal en esta posición. Inténtalo de nuevo.',
      studyNextExercise: 'Elegir otro ejercicio',
      studyProgress: '{{completed}} de {{total}} completados',
      studyCompleted: 'Completado',
      studyResetProgress: 'Restablecer progreso',
      studyResetConfirmation: '¿Restablecer todo el progreso de estudio en este navegador?',
  ...
  fr: {
    translation: {
      ...
      studyNav: 'Étudier',
      moreNavigation: 'Plus',
      studyEyebrow: 'Étude d’échecs',
      studyTitle: 'Trouvez le coup qui compte.',
      studyDescription:
        'Résolvez une position ciblée, recevez un indice et apprenez avec l’explication.',
      studyCatalog: 'Exercices d’étude',
      'studyCategory.mate-in-one': 'Mat en un coup',
      'studyCategory.win-material': 'Gagner du matériel',
      'studyCategory.find-the-best-move': 'Trouver le meilleur coup',
      'studySide.white': 'Aux blancs de jouer',
      'studySide.black': 'Aux noirs de jouer',
      studyOpenExercise: 'Ouvrir l’exercice',
      studyBack: 'Retour aux exercices',
      studyBoardLabel: 'Échiquier d’étude',
      studyChoosePiece: 'Sélectionnez une de vos pièces pour commencer.',
      studyChooseDestination: 'Choisissez maintenant sa destination.',
      studyChecking: 'Vérification du coup…',
      studyCorrect: 'Correct.',
      studyTryAgain: 'Réessayez.',
      studyInvalidMove: 'Ce coup n’est pas légal dans cette position. Réessayez.',
      studyNextExercise: 'Choisir un autre exercice',
      studyProgress: '{{completed}} sur {{total}} terminés',
      studyCompleted: 'Terminé',
      studyResetProgress: 'Réinitialiser la progression',
      studyResetConfirmation: 'Réinitialiser toute la progression d’étude dans ce navigateur ?',
