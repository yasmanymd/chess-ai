...
| Field        | Value                                                                                         |
| ------------ | --------------------------------------------------------------------------------------------- |
| Status       | Chrome and Safari evidence complete; Firefox and Edge remain explicit pending work            |
...
| Chrome desktop and Safari desktop  | French            | Yasmany confirmed the final physical pass for the critical journeys after the M6.4 corrections.                             | Observed and approved          | Yasmany acceptance, 2026-08-27; M6.4 Playwright suite                  |
| iPhone Safari                      | French            | Yasmany confirmed the final physical pass for the critical journeys after the M6.4 corrections.                             | Observed and approved          | Yasmany acceptance, 2026-08-27; M6.4 Playwright suite                  |
...
Chrome and Safari coverage for the approved MVP scope is complete. Future browser validation should use one clean browser session per locale and record browser/version, device or viewport, date, journey result, and any defect link. Do not infer physical-browser success from Playwright alone.
